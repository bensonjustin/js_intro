...
var peanutsGang = ['Charlie', 'Snoopy', 'Woodstock', 'Linus', 'Lucy'];
...
var myFav = "My favorite Peanuts charcter is " + peanuts + ".";
console.log(myFav);
...
var cryptocurrency = 3000;
var newSavings = newSavings - cryptocurrency;
console.log(newSavings);
...
function newSavings2(newSavings){
    if(newSavings % 2 === 0){
    return newSavings + 500;
}else{
    return newSavings;
}
}
console.log(newSavings2(newSavings));
...
var tax = .3;
var adjustedSavings = newSavings + 500 * (1 - tax);
...
var firstQuarter = adjustedSavings * .02 / 4;
